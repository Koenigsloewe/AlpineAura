    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_method', models.CharField(choices=[('SD', 'Standard Delivery'), ('ED', 'Express Delivery'), ('ND', 'Next Day Delivery'), ('WD', 'Weekend Delivery'), ('HD', 'Heavy or Bulky Item Delivery')], help_text='Required', max_length=255, verbose_name='delivery_method')),
